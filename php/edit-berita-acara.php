...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    $_SESSION['error'] = 'ID Berita Acara tidak ditemukan';
...
if (mysqli_num_rows($result) == 0) {
    $_SESSION['error'] = 'Data Berita Acara tidak ditemukan';
    header('Location: berita-acara.php');
    exit;
}
...
<head>
    ...
    <title>Edit Berita Acara - DPPKBPM</title>
        ...
        <main class="main-content">
            ...
            <header class="header">
                <div class="header-left">
                    ...
                    <h1 class="header-title">Edit Berita Acara</h1>
                </div>
            ...
            <div class="content">
                ...
                <div class="breadcrumb">
                    ...
                    <span class="separator">/</span>
                    <span class="current">Edit Berita Acara</span>
                </div>

                <!-- Form Box -->
                <div class="content-box">
                    <div class="box-header">
                        <h2><i class="fas fa-file-contract"></i> Form Edit Berita Acara</h2>
                    </div>
                        ...
                        <form id="formBeritaAcara" method="POST" action="proses-berita-acara.php">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="no_agenda" name="no_agenda" value="<?= htmlspecialchars($data['no_agenda'] ?? '') ?>" placeholder="Masukkan No Agenda">
                                </div>
                                <div class="form-group">
                                    <label for="no_berita_acara">
                                        <i class="fas fa-file-invoice"></i> No Berita Acara
                                    </label>
                                    <input type="text" id="no_berita_acara" name="no_berita_acara" value="<?= htmlspecialchars($data['no_berita_acara'] ?? '') ?>" placeholder="Masukkan No Berita Acara">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="tanggal_serah_terima" name="tanggal_serah_terima" value="<?= htmlspecialchars($data['tanggal_serah_terima']) ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="uraian" name="uraian" rows="4"
                                    required><?= htmlspecialchars($data['uraian']) ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nilai_pengadaan" name="nilai_pengadaan"
                                    value="<?= htmlspecialchars($data['nilai_pengadaan'] ?? '') ?>" placeholder="Masukkan nilai pengadaan">
                            </div>
