...
// Query data yang akan diedit
$query = "SELECT * FROM daftar_arsip_vital WHERE id = $id";
...
<head>
    ...
    <title>Edit Daftar Arsip Vital - DPPKBPM</title>
    ...
    <div class="container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                <!-- Keep the navigation exact same as others -->
        ...
        <main class="main-content">
            ...
            <header class="header">
                <div class="header-left">
                    ...
                    <h1 class="header-title">Edit Daftar Arsip Vital</h1>
                </div>
            ...
            <div class="content">
                ...
                <div class="content-box">
                    <div class="box-header">
                        <h2><i class="fas fa-edit"></i> Form Edit Daftar Arsip Vital</h2>
                    </div>
                        ...
                        <form id="formArsipVital" method="POST" action="proses-daftar-arsip-vital.php">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="jenis_arsip" name="jenis_arsip" value="<?php echo htmlspecialchars($data['jenis_arsip']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="tingkat_perkembangan">
                                        <i class="fas fa-layer-group"></i> Tingkat Perkembangan <span class="required">*</span>
                                    </label>
                                    <input type="text" id="tingkat_perkembangan" name="tingkat_perkembangan" value="<?php echo htmlspecialchars($data['tingkat_perkembangan']); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="kurun_waktu" name="kurun_waktu" value="<?php echo htmlspecialchars($data['kurun_waktu']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="media">
                                        <i class="fas fa-compact-disc"></i> Media <span class="required">*</span>
                                    </label>
                                    <input type="text" id="media" name="media" value="<?php echo htmlspecialchars($data['media']); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="jangka_simpan" name="jangka_simpan" value="<?php echo htmlspecialchars($data['jangka_simpan']); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="lokasi_simpan" name="lokasi_simpan" value="<?php echo htmlspecialchars($data['lokasi_simpan']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="metode_perlindungan">
                                        <i class="fas fa-shield-alt"></i> Metode Perlindungan <span class="required">*</span>
                                    </label>
                                    <input type="text" id="metode_perlindungan" name="metode_perlindungan" value="<?php echo htmlspecialchars($data['metode_perlindungan']); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="keterangan" name="keterangan" rows="3"><?php echo htmlspecialchars($data['keterangan']); ?></textarea>
                            </div>
