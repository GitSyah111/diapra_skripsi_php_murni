...
$query = "SELECT surat_masuk.*, user.nama_bidang, user.username,
          ...
          WHERE surat_masuk.status_disposisi = 'Belum diproses'
...
<head>
    ...
    <title>Surat Masuk Belum Disposisi - DPPKBPM</title>
        ...
        <main class="main-content">
            ...
            <header class="header">
                <div class="header-left">
                    ...
                    <h1 class="header-title">Surat Masuk Belum Disposisi</h1>
                </div>
            ...
            <div class="content">
                ...
                <div class="content-box">
                    <div class="box-header">
                        <h2><i class="fas fa-clock"></i> Daftar Surat Masuk Belum Disposisi</h2>
