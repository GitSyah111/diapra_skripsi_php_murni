...
<head>
    ...
    <title>Tambah Pernyataan Verifikasi BMD - DPPKBPM</title>
...
<body>
    <div class="container">
        <!-- Sidebar disingkat sementara tapi harus lengkap mengikuti yang lain untuk proper layout -->
        <?php // Normally this would be include 'sidebar.php' but we are copying it ?>
        ...
        <main class="main-content">
            <header class="header">
                <div class="header-left">
                    <h1 class="header-title">Tambah Pernyataan Verifikasi BMD</h1>
                </div>
            </header>
                        ...
                        <form id="formPernyataan" method="POST" action="proses-pernyataan-bmd.php">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="no_surat_pernyataan" name="no_surat_pernyataan">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="no_pesanan_kontrak" name="no_pesanan_kontrak">
                                </div>
                                <div class="form-group">
                                    <label for="tgl_pesan_kontrak"><i class="fas fa-calendar-alt"></i> Tgl Pesan/Kontrak</label>
                                    <input type="date" id="tgl_pesan_kontrak" name="tgl_pesan_kontrak">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nilai_pesanan_kontrak" name="nilai_pesanan_kontrak">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="tgl_bast" name="tgl_bast">
                                </div>
                            </div>
